				 ...
				 specDone: function(result) {
					 if (result.status == 'failed') {
						 browser.getCapabilities().then(function (caps) {
							...
							var stream = fs.createWriteStream(`xyz-bank-demo\\test-1\\screenshots`+ browserName + '-' + result.fullName+ '.png');
		 ...
		 onComplete: function() {
			 ...
			 capsPromise.then(function (caps) {
				...
				testConfig = {
					...
					outputPath: 'xyz-bank-demo\\test-1',
					outputFilename: 'ProtractorTestReport',
					screenshotPath: `xyz-bank-demo\\test-1\\screenshots`,
				...
				new HTMLReport().from(`xyz-bank-demo\\test-1\\guitest-xmloutput.xml`, testConfig);
			});
		},
